...
The system integrates two microphones, an audio codec, an audio power amplifier and a speaker.
These peripherals are driven with two separate RP2040 MCU units, one for playback and one for recording, that can synchronize timebase via a shared GPIO signal.
